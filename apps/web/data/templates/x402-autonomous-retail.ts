...
@animation
  ...
  step 10: camera settlement1
    name: "문제 강조"
    description: "settlement1 노드로 카메라를 이동합니다."
    cameraAction: focus
    zoom: 2
    padding: 30px
    duration: 1.5s

  step 11: camera start, phase1_banner, phase2_banner, settlement1, settlement2, end
    name: "전체 흐름 조망"
    description: "Phase 1의 문제를 한눈에 봅니다."
    cameraAction: fitNodes
    padding: 60px
    duration: 2s

  step 12: show phase2_banner
    name: "Phase 2: X402 Smart Era"
    description: "이제 X402와 AI가 모든 것을 자동화합니다."
    effect: fadeIn
    duration: 1s

  step 13: show customer_p2, owner_p2
    name: "새로운 환경"
  ...
  step 14: show ai_ask, auto_trigger
    name: "자동화 시작"
  ...
  step 15: show auto_pay, demand_agg
    name: "스마트 처리"
  ...
  step 16: show settlement2
    name: "X402 온체인 정산"
    description: "모든 거래가 블록체인 위에서 투명하게, 즉시 정산됩니다."
    effect: fadeIn
    duration: 1s

  step 17: highlight settlement2
    name: "솔루션 강조"
    description: "X402의 가치를 강조합니다."
    color: #FFD700
    glow: true
    pulse: true
    duration: 2.5s

  step 18: camera settlement2
    name: "솔루션 포커스"
    description: "settlement2 노드로 카메라를 이동합니다."
    cameraAction: focus
    zoom: 2
    padding: 30px
    duration: 1.5s
