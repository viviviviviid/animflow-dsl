...
@animation
  ...
  step 8: connect store->request, request->verify
    name: "보호 API 요청 경로 연결"
    description: "store에서 verify까지 보호 API 요청 경로를 연결합니다."
    flow: particles
    speed: 1s

  step 9: show request, verify
    name: "요청/검증 노드 표시"
  ...
  step 11: connect verify->success
    name: "검증 성공 연결"
  ...
  step 14: connect validate->fail, verify->fail
    name: "실패 경로 연결"
