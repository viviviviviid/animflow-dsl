import React4, { forwardRef, useRef, useState, useMemo, useEffect, useCallback, useImperativeHandle } from 'react';
  ...
  switch (shape) {
    ...
    case "diamond":
      ...
      const points = `
        ...
        ${x},${cy}
      `;
      return /* @__PURE__ */ jsx("polygon", { points, ...commonProps });
    case "parallelogram":
      ...
      const paraPoints = `
        ...
        ${x},${y + height}
      `;
      return /* @__PURE__ */ jsx("polygon", { points: paraPoints, ...commonProps });
    case "database":
    ...
    case "document":
      const wavePath = `
        ...
        Z
      `;
      return /* @__PURE__ */ jsx("path", { d: wavePath, ...commonProps });
    default:
      return /* @__PURE__ */ jsx(
        "rect",
        {
...
function renderText(label, subtitle, cx, cy, color) {
  ...
  return /* @__PURE__ */ jsx(
    "text",
    {
      ...
      children: lines.map((line, i) => /* @__PURE__ */ jsx("tspan", { x: cx, dy: i === 0 ? 0 : lineHeight, children: line }, i))
    }
  );
}
...
function ArrowMarkerDef() {
  return /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx(
    "marker",
    {
      ...
      children: /* @__PURE__ */ jsx("path", { d: "M0,0 L0,3 L4,1.5 z", fill: "#757575" })
    }
  ) });
}
  ...
  return /* @__PURE__ */ jsxs(
    "g",
    {
      ...
      children: [
        ...
        roughPaths.pathOps.length > 0 && /* @__PURE__ */ jsx("g", { className: "rough-path-container", style: { opacity: 0 }, children: roughPaths.pathOps.map((set, i) => /* @__PURE__ */ jsx(
          "path",
          {
            d: opsToPath(set),
            stroke,
        ...
        roughPaths.arrowOps.length > 0 && /* @__PURE__ */ jsx("g", { className: "rough-arrow-overlay", style: { opacity: 0 }, children: roughPaths.arrowOps.map((set, i) => /* @__PURE__ */ jsx(
          "path",
          {
            d: opsToPath(set),
...
function DiagramRenderer({
  ...
  const edgesLayer = useMemo(
    () => data.edges.map(
      (edge) => renderMode === "clean" ? /* @__PURE__ */ jsx(EdgeRenderer, { edge }, edge.id) : /* @__PURE__ */ jsx(RoughEdgeRenderer, { edge }, edge.id)
    ),
    [data.edges, renderMode]
  );
  const nodesLayer = useMemo(
    () => data.nodes.map(
      (node) => renderMode === "clean" ? /* @__PURE__ */ jsx(NodeRenderer, { node }, node.id) : /* @__PURE__ */ jsx(RoughNodeRenderer, { node }, node.id)
    ),
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      style: { background },
      children: [
        renderMode === "clean" && /* @__PURE__ */ jsx(ArrowMarkerDef, {}),
        /* @__PURE__ */ jsx("g", { className: "edges-layer", children: edgesLayer }),
        /* @__PURE__ */ jsx("g", { className: "nodes-layer", children: nodesLayer })
      ]
    }
  );
}
...
function NarrationOverlay({ narration }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "relative border-t border-gray-200 bg-gray-50/95 px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold text-gray-900 mb-1", children: narration.title }),
    /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-700 leading-relaxed", children: narration.text })
  ] }) });
}
var useDiagramStore = create((set) => ({
  // Initial state
  diagramData: null,
  isPlaying: false,
  currentStep: 0,
...
function PlaybackControls({
  ...
  const progressBarRef = React4.useRef(null);
  const [hoverPercent, setHoverPercent] = React4.useState(null);
  const [hoverSegmentStep, setHoverSegmentStep] = React4.useState(null);
  const [hoverTooltipX, setHoverTooltipX] = React4.useState(null);
  ...
  return /* @__PURE__ */ jsx("div", { className: "bg-white border-t border-gray-200 p-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto space-y-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
    !isPlaying ? /* @__PURE__ */ jsx(
      "button",
      {
        ...
        title: "\uC7AC\uC0DD",
        "aria-label": "\uC7AC\uC0DD",
        children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M8 5v14l11-7z" }) })
      }
    ) : /* @__PURE__ */ jsx(
      "button",
      {
        ...
        title: "\uC77C\uC2DC\uC815\uC9C0",
        "aria-label": "\uC77C\uC2DC\uC815\uC9C0",
        children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M6 4h4v16H6V4zm8 0h4v16h-4V4z" }) })
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: "relative flex-1", children: [
      hoverSegmentStep !== null && hoverTooltipX !== null && (stepDetails[hoverSegmentStep]?.title || stepDetails[hoverSegmentStep]?.text) && /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            stepDetails[hoverSegmentStep]?.title && /* @__PURE__ */ jsx("div", { className: "font-semibold", children: stepDetails[hoverSegmentStep]?.title }),
            stepDetails[hoverSegmentStep]?.text && /* @__PURE__ */ jsx("div", { className: "mt-1 line-clamp-2 text-gray-200", children: stepDetails[hoverSegmentStep]?.text })
          ]
        }
      ),
      stepBoundaries.length > 0 ? /* @__PURE__ */ jsxs(
        "div",
        {
          ref: progressBarRef,
          ...
          children: [
            isHoveringBar && previewWidth > 0 && /* @__PURE__ */ jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsx("div", { className: "h-full w-full flex gap-[2px]", children: stepBoundaries.map((segment, index) => {
...
var AnimflowPlayer = forwardRef(
  function AnimflowPlayer2({
    ...
    const handleSvgReady = useCallback((svg) => {
      svgRef.current = svg;
    }, []);
    ...
    if (error) {
      return /* @__PURE__ */ jsx("div", { className: `flex items-center justify-center h-full bg-red-50 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("p", { className: "text-red-600 font-semibold mb-2", children: "\uC624\uB958 \uBC1C\uC0DD" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: error })
      ] }) });
    }
    if (!localDiagramData) {
      return /* @__PURE__ */ jsx("div", { className: `flex items-center justify-center h-full bg-gray-50 ${className}`, children: /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: "\uB85C\uB529 \uC911..." }) });
    }
    const canvasBackground = renderMode === "sketchy" ? "#faf9f6" : localDiagramData.config.background || "#ffffff";
    return /* @__PURE__ */ jsxs("div", { className: `relative h-full flex flex-col ${className}`, children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-4 left-4 z-10 flex flex-col gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      localDiagramData.config.narration !== false && narration && /* @__PURE__ */ jsx(NarrationOverlay, { narration: currentNarration }),
      localDiagramData.config.controls !== false && controls && /* @__PURE__ */ jsx(
        PlaybackControls,
        {
          onPlay: handlePlay,
          onPause: handlePause,
...
export { AnimflowPlayer, DiagramRenderer, calculateFlowchartLayout, parseDsl };
